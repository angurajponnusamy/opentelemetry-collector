...
func genTestFailingUnmarshalProtoValuesSpan() map[string][]byte {
	return map[string][]byte{
		...
		"ParentSpanId/wrong_wire_type":           []byte{0x24},
		"ParentSpanId/missing_value":             []byte{0x22},
		"Flags/wrong_wire_type":                  []byte{0x84, 0x1},
		"Flags/missing_value":                    []byte{0x85, 0x1},
		"Name/wrong_wire_type":                   []byte{0x2c},
		"Name/missing_value":                     []byte{0x2a},
		"Kind/wrong_wire_type":                   []byte{0x34},
		"Kind/missing_value":                     []byte{0x30},
		"StartTimeUnixNano/wrong_wire_type":      []byte{0x3c},
		"StartTimeUnixNano/missing_value":        []byte{0x39},
		"EndTimeUnixNano/wrong_wire_type":        []byte{0x44},
		"EndTimeUnixNano/missing_value":          []byte{0x41},
		"Attributes/wrong_wire_type":             []byte{0x4c},
		"Attributes/missing_value":               []byte{0x4a},
		"DroppedAttributesCount/wrong_wire_type": []byte{0x54},
		"DroppedAttributesCount/missing_value":   []byte{0x50},
		"Events/wrong_wire_type":                 []byte{0x5c},
		"Events/missing_value":                   []byte{0x5a},
		"DroppedEventsCount/wrong_wire_type":     []byte{0x64},
		"DroppedEventsCount/missing_value":       []byte{0x60},
		"Links/wrong_wire_type":                  []byte{0x6c},
		"Links/missing_value":                    []byte{0x6a},
		"DroppedLinksCount/wrong_wire_type":      []byte{0x74},
		"DroppedLinksCount/missing_value":        []byte{0x70},
		"Status/wrong_wire_type":                 []byte{0x7c},
		"Status/missing_value":                   []byte{0x7a},
	}
}
...
func genTestEncodingValuesSpan() map[string]*Span {
	return map[string]*Span{
		...
		"Events/test":                 {Events: []*SpanEvent{&SpanEvent{}, GenTestSpanEvent()}},
		"DroppedEventsCount/test":     {DroppedEventsCount: uint32(13)},
		"Links/test":                  {Links: []*SpanLink{&SpanLink{}, GenTestSpanLink()}},
