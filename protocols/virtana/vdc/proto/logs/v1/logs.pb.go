...
// 	protoc        v3.16.3
// source: virtana/vdc/proto/logs/v1/logs.proto
...
func (SeverityNumber) Descriptor() protoreflect.EnumDescriptor {
	return file_virtana_vdc_proto_logs_v1_logs_proto_enumTypes[0].Descriptor()
}

func (SeverityNumber) Type() protoreflect.EnumType {
	return &file_virtana_vdc_proto_logs_v1_logs_proto_enumTypes[0]
}
...
func (SeverityNumber) EnumDescriptor() ([]byte, []int) {
	return file_virtana_vdc_proto_logs_v1_logs_proto_rawDescGZIP(), []int{0}
}
...
func (LogRecordFlags) Descriptor() protoreflect.EnumDescriptor {
	return file_virtana_vdc_proto_logs_v1_logs_proto_enumTypes[1].Descriptor()
}

func (LogRecordFlags) Type() protoreflect.EnumType {
	return &file_virtana_vdc_proto_logs_v1_logs_proto_enumTypes[1]
}
...
func (LogRecordFlags) EnumDescriptor() ([]byte, []int) {
	return file_virtana_vdc_proto_logs_v1_logs_proto_rawDescGZIP(), []int{1}
}
...
func (x *LogsData) Reset() {
	*x = LogsData{}
	mi := &file_virtana_vdc_proto_logs_v1_logs_proto_msgTypes[0]
...
func (x *ResourceLogs) Reset() {
	*x = ResourceLogs{}
	mi := &file_virtana_vdc_proto_logs_v1_logs_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *ScopeLogs) Reset() {
	*x = ScopeLogs{}
	mi := &file_virtana_vdc_proto_logs_v1_logs_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ScopeLogs) Descriptor() ([]byte, []int) {
	return file_virtana_vdc_proto_logs_v1_logs_proto_rawDescGZIP(), []int{2}
}
...
type LogRecord struct {
	...
	SeverityNumber         SeverityNumber         `protobuf:"varint,2,opt,name=severity_number,json=severityNumber,proto3,enum=virtana.vdc.proto.logs.v1.SeverityNumber" json:"severity_number,omitempty"`
...
func (x *LogRecord) Reset() {
	*x = LogRecord{}
	mi := &file_virtana_vdc_proto_logs_v1_logs_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LogRecord) Descriptor() ([]byte, []int) {
	return file_virtana_vdc_proto_logs_v1_logs_proto_rawDescGZIP(), []int{3}
}
...
var File_virtana_vdc_proto_logs_v1_logs_proto protoreflect.FileDescriptor

const file_virtana_vdc_proto_logs_v1_logs_proto_rawDesc = "" +
	"\n" +
	"$virtana/vdc/proto/logs/v1/logs.proto\x12\x19virtana.vdc.proto.logs.v1\x1a*opentelemetry/proto/common/v1/common.proto\x1a,virtana/vdc/proto/resource/v1/resource.proto\"X\n" +
	"\bLogsData\x12L\n" +
	"\rresource_logs\x18\x01 \x03(\v2'.virtana.vdc.proto.logs.v1.ResourceLogsR\fresourceLogs\"\xbf\x01\n" +
	"\fResourceLogs\x12C\n" +
	"\bresource\x18\x01 \x01(\v2'.virtana.vdc.proto.resource.v1.ResourceR\bresource\x12C\n" +
	"\n" +
	"scope_logs\x18\x02 \x03(\v2$.virtana.vdc.proto.logs.v1.ScopeLogsR\tscopeLogs\x12\x1d\n" +
	"\n" +
	"schema_url\x18\x03 \x01(\tR\tschemaUrlJ\x06\b\xe8\a\x10\xe9\a\"\xbc\x01\n" +
	"\tScopeLogs\x12I\n" +
	"\x05scope\x18\x01 \x01(\v23.opentelemetry.proto.common.v1.InstrumentationScopeR\x05scope\x12E\n" +
	"\vlog_records\x18\x02 \x03(\v2$.virtana.vdc.proto.logs.v1.LogRecordR\n" +
	"logRecords\x12\x1d\n" +
	"\n" +
	"schema_url\x18\x03 \x01(\tR\tschemaUrl\"\x90\x04\n" +
	"\tLogRecord\x12$\n" +
	"\x0etime_unix_nano\x18\x01 \x01(\x06R\ftimeUnixNano\x125\n" +
	"\x17observed_time_unix_nano\x18\v \x01(\x06R\x14observedTimeUnixNano\x12R\n" +
	"\x0fseverity_number\x18\x02 \x01(\x0e2).virtana.vdc.proto.logs.v1.SeverityNumberR\x0eseverityNumber\x12#\n" +
	...
	"!LOG_RECORD_FLAGS_TRACE_FLAGS_MASK\x10\xff\x01Bh\n" +
	"\x1cio.virtana.vdc.proto.logs.v1B\tLogsProtoP\x01Z\x1fgo.virtana.io/vdc/proto/logs/v1\xaa\x02\x19Virtana.Vdc.Proto.Logs.V1b\x06proto3"

var (
	file_virtana_vdc_proto_logs_v1_logs_proto_rawDescOnce sync.Once
	file_virtana_vdc_proto_logs_v1_logs_proto_rawDescData []byte
)

func file_virtana_vdc_proto_logs_v1_logs_proto_rawDescGZIP() []byte {
	file_virtana_vdc_proto_logs_v1_logs_proto_rawDescOnce.Do(func() {
		file_virtana_vdc_proto_logs_v1_logs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_virtana_vdc_proto_logs_v1_logs_proto_rawDesc), len(file_virtana_vdc_proto_logs_v1_logs_proto_rawDesc)))
	})
	return file_virtana_vdc_proto_logs_v1_logs_proto_rawDescData
}

var file_virtana_vdc_proto_logs_v1_logs_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_virtana_vdc_proto_logs_v1_logs_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_virtana_vdc_proto_logs_v1_logs_proto_goTypes = []any{
	(SeverityNumber)(0),              // 0: virtana.vdc.proto.logs.v1.SeverityNumber
	(LogRecordFlags)(0),              // 1: virtana.vdc.proto.logs.v1.LogRecordFlags
	(*LogsData)(nil),                 // 2: virtana.vdc.proto.logs.v1.LogsData
	(*ResourceLogs)(nil),             // 3: virtana.vdc.proto.logs.v1.ResourceLogs
	(*ScopeLogs)(nil),                // 4: virtana.vdc.proto.logs.v1.ScopeLogs
	(*LogRecord)(nil),                // 5: virtana.vdc.proto.logs.v1.LogRecord
	(*v1.Resource)(nil),              // 6: virtana.vdc.proto.resource.v1.Resource
...
var file_virtana_vdc_proto_logs_v1_logs_proto_depIdxs = []int32{
	3, // 0: virtana.vdc.proto.logs.v1.LogsData.resource_logs:type_name -> virtana.vdc.proto.logs.v1.ResourceLogs
	6, // 1: virtana.vdc.proto.logs.v1.ResourceLogs.resource:type_name -> virtana.vdc.proto.resource.v1.Resource
	4, // 2: virtana.vdc.proto.logs.v1.ResourceLogs.scope_logs:type_name -> virtana.vdc.proto.logs.v1.ScopeLogs
	7, // 3: virtana.vdc.proto.logs.v1.ScopeLogs.scope:type_name -> opentelemetry.proto.common.v1.InstrumentationScope
	5, // 4: virtana.vdc.proto.logs.v1.ScopeLogs.log_records:type_name -> virtana.vdc.proto.logs.v1.LogRecord
	0, // 5: virtana.vdc.proto.logs.v1.LogRecord.severity_number:type_name -> virtana.vdc.proto.logs.v1.SeverityNumber
	8, // 6: virtana.vdc.proto.logs.v1.LogRecord.body:type_name -> opentelemetry.proto.common.v1.AnyValue
	9, // 7: virtana.vdc.proto.logs.v1.LogRecord.attributes:type_name -> opentelemetry.proto.common.v1.KeyValue
...
func init() { file_virtana_vdc_proto_logs_v1_logs_proto_init() }
func file_virtana_vdc_proto_logs_v1_logs_proto_init() {
	if File_virtana_vdc_proto_logs_v1_logs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_virtana_vdc_proto_logs_v1_logs_proto_rawDesc), len(file_virtana_vdc_proto_logs_v1_logs_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_virtana_vdc_proto_logs_v1_logs_proto_goTypes,
		DependencyIndexes: file_virtana_vdc_proto_logs_v1_logs_proto_depIdxs,
		EnumInfos:         file_virtana_vdc_proto_logs_v1_logs_proto_enumTypes,
		MessageInfos:      file_virtana_vdc_proto_logs_v1_logs_proto_msgTypes,
	}.Build()
	File_virtana_vdc_proto_logs_v1_logs_proto = out.File
	file_virtana_vdc_proto_logs_v1_logs_proto_goTypes = nil
	file_virtana_vdc_proto_logs_v1_logs_proto_depIdxs = nil
}
