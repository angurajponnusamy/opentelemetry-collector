...
const (
	TraceService_Export_FullMethodName = "/virtana.vdc.proto.collector.traces.v1.TraceService/Export"
)
...
//
// Service that can be used to push traces between one Application
